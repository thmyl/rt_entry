...
// DEFINE_string(centroids_path, "/data/myl/sift100M/centroids_1000", "path of centroids file produced by clustering");
...
DEFINE_string(data_name, "/mnt/IntelP5520_8T_1/myl/cache_search/data/sift100M", "name of datasets");
DEFINE_string(data_path, "/mnt/IntelP5520_8T_1/myl/sift100M/sift100M_base.fbin", "path of datasets");
DEFINE_string(query_path, "/mnt/IntelP5520_8T_1/myl/sift100M/sift100M_query.fvecs", "path of queries");
DEFINE_string(gt_path, "/mnt/IntelP5520_8T_1/myl/sift100M/sift100M_groundtruth.ivecs", "path of the ground truth");
DEFINE_string(centroids_path, "/mnt/IntelP5520_8T_1/myl/cache_search/data/sift100M/centroids_10000_hilbert", "path of centroids file produced by clustering");
DEFINE_string(graph_path, "/mnt/IntelP5520_8T_1/myl/sift100M/index/sift100M_128_64_diskann.nsw", "path of the graph");
...
// DEFINE_string(centroids_path, "/data/myl/cache_search/data/deep1M/centroids_100", "path of centroids file produced by clustering");
...
// DEFINE_string(centroids_path, "/data/myl/cache_search/data/deep10M/centroids_100", "path of centroids file produced by clustering");


/* deep100M */
// // // DEFINE_string(data_name, "/data/myl/deep100M/index/pca", "name of datasets");
// // DEFINE_string(data_name, "/data/myl/cache_search/data/deep100M", "name of datasets");
...
// // DEFINE_string(gt_path, "/data/myl/deep100M/deep100M_gt_new.ivecs", "path of the ground truth");
// // DEFINE_string(graph_path, "/data/myl/deep100M/index/deep100M_128_64_diskann_new.nsw", "path of the graph");
// // DEFINE_string(centroids_path, "/data/myl/deep100M/centroids_1000", "path of centroids file produced by clustering");
// // // DEFINE_string(graph_path, "/home/myl/rt_entry/input_file/deep1M_32_16.nsw", "path of the graph");
// // // DEFINE_string(graph_path, "/home/myl/rt_entry/input_file/deep1M_64_32.nsw", "path of the graph");
// // DEFINE_string(data_name, "/data/myl/deep100M/index/pca", "name of datasets");
// DEFINE_string(data_name, "/mnt/IntelP5520_8T_1/myl/cache_search/data/deep100M", "name of datasets");
// DEFINE_string(data_path, "/mnt/IntelP5520_8T_1/myl/deep100M/fbin/deep100M_base.fbin", "path of datasets");
// DEFINE_string(query_path, "/mnt/IntelP5520_8T_1/myl/deep100M/deep100M_query.fvecs", "path of queries");
// // DEFINE_string(gt_path, "/data/myl/deep100M/deep100M_groundtruth.ivecs", "path of the ground truth");
// DEFINE_string(gt_path, "/mnt/IntelP5520_8T_1/myl/deep100M/deep100M_gt_new.ivecs", "path of the ground truth");
// DEFINE_string(graph_path, "/mnt/IntelP5520_8T_1/myl/deep100M/index/deep100M_400_64_diskann.nsw", "path of the graph");
// DEFINE_string(centroids_path, "/mnt/IntelP5520_8T_1/myl/cache_search/data/deep100M/centroids_5000_faiss_hilbert", "path of centroids file produced by clustering");
// // DEFINE_string(graph_path, "/home/myl/rt_entry/input_file/deep1M_32_16.nsw", "path of the graph");
// // DEFINE_string(graph_path, "/home/myl/rt_entry/input_file/deep1M_64_32.nsw", "path of the graph");
...
// DEFINE_string(centroids_path, "/data/myl/cache_search/data/gist/centroids_100", "path of centroids file produced by clustering");
...
// DEFINE_string(centroids_path, "", "path of centroids file produced by clustering");
/* uqv */

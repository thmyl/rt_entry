...
__global__ void GraphSearchKernel(float* d_data, const float* query_full, int* d_results, int* d_graph, int* d_candidates, int np,
                      ...
                      const float* linear_w,
                      const float* linear_b,
                      int linear_dim/*, int linear_w_low, int linear_b_low, int linear_w_high, int linear_b_high*/){
  ...
  float linear_w_low = linear_w[DIM];
  float linear_b_low = linear_b[DIM];
  float linear_w_high = linear_w[DIM+PARTIAL_DIM];
  float linear_b_high = linear_b[DIM+PARTIAL_DIM];
//   int max_iter = 10;
...
// #region PARTIAL_DIM d_query loading without DEFINE
    float q1_tail = 0;
    if(lane_id < PARTIAL_DIM){
        q1_tail = query_full[q_id * FULL_DIM + DIM + lane_id];
    }
    ...
    //     q30_tail = query_full[q_id * FULL_DIM + DIM + lane_id + 928];
    // }
// #endregion PARTIAL_DIM d_query loading without DEFINE
...
// insert entry points
  ...
  //add entry points
    ...
    // insert
        ...
        int calc_dim = in_cache ? PARTIAL_DIM : 0;
        // int calc_dim = PARTIAL_DIM;
        int used_dim = calc_dim + DIM;
        // int used_dim = DIM;
        ...
        //     // #region PARTIAL_DIM d_data loading without DEFINE
        //         float p1 = 0;
        //         if(lane_id < calc_dim){
        //             p1 = page_ptr[lane_id];
        //         }
        //         float p2 = 0;
        //         if(lane_id + 32 < calc_dim){
        //             p2 = page_ptr[lane_id + 32];
        //         }
        //         float p3 = 0;
        //         if(lane_id + 64 < calc_dim){
        //             p3 = page_ptr[lane_id + 64];
        //         }
        //         // float p4 = 0;
        //         // if(lane_id + 96 < calc_dim){
        //         //     p4 = page_ptr[lane_id + 96];
        //         // }
        //         // float p5 = 0;
        //         // if(lane_id + 128 < calc_dim){
        //         //     p5 = page_ptr[lane_id + 128];
        //         // }
        //         // float p6 = 0;
        //         // if(lane_id + 160 < calc_dim){
        //         //     p6 = page_ptr[lane_id + 160];
        //         // }
        //         // float p7 = 0;
        //         // if(lane_id + 192 < calc_dim){
        //         //     p7 = page_ptr[lane_id + 192];
        //         // }
        //         // float p8 = 0;
        //         // if(lane_id + 224 < calc_dim){
        //         //     p8 = page_ptr[lane_id + 224];
        //         // }
        //         // float p9 = 0;
        //         // if(lane_id + 256 < calc_dim){
        //         //     p9 = page_ptr[lane_id + 256];
        //         // }
        //         // float p10 = 0;
        //         // if(lane_id + 288 < calc_dim){
        //         //     p10 = page_ptr[lane_id + 288];
        //         // }
        //         // float p11 = 0;
        //         // if(lane_id + 320 < calc_dim){
        //         //     p11 = page_ptr[lane_id + 320];
        //         // }
        //         // float p12 = 0;
        //         // if(lane_id + 352 < calc_dim){
        //         //     p12 = page_ptr[lane_id + 352];
        //         // }
        //         // float p13 = 0;
        //         // if(lane_id + 384 < calc_dim){
        //         //     p13 = page_ptr[lane_id + 384];
        //         // }
        //         // float p14 = 0;
        //         // if(lane_id + 416 < calc_dim){
        //         //     p14 = page_ptr[lane_id + 416];
        //         // }
        //         // float p15 = 0;
        //         // if(lane_id + 448 < calc_dim){
        //         //     p15 = page_ptr[lane_id + 448];
        //         // }
        //         // float p16 = 0;
        //         // if(lane_id + 480 < calc_dim){
        //         //     p16 = page_ptr[lane_id + 480];
        //         // }
        //         // float p17 = 0;
        //         // if(lane_id + 512 < calc_dim){
        //         //     p17 = page_ptr[lane_id + 512];
        //         // }
        //         // float p18 = 0;
        //         // if(lane_id + 544 < calc_dim){
        //         //     p18 = page_ptr[lane_id + 544];
        //         // }
        //         // float p19 = 0;
        //         // if(lane_id + 576 < calc_dim){
        //         //     p19 = page_ptr[lane_id + 576];
        //         // }
        //         // float p20 = 0;
        //         // if(lane_id + 608 < calc_dim){
        //         //     p20 = page_ptr[lane_id + 608];
        //         // }
        //         // float p21 = 0;
        //         // if(lane_id + 640 < calc_dim){
        //         //     p21 = page_ptr[lane_id + 640];
        //         // }
        //         // float p22 = 0;
        //         // if(lane_id + 672 < calc_dim){
        //         //     p22 = page_ptr[lane_id + 672];
        //         // }
        //         // float p23 = 0;
        //         // if(lane_id + 704 < calc_dim){
        //         //     p23 = page_ptr[lane_id + 704];
        //         // }
        //         // float p24 = 0;
        //         // if(lane_id + 736 < calc_dim){
        //         //     p24 = page_ptr[lane_id + 736];
        //         // }
        //         // float p25 = 0;
        //         // if(lane_id + 768 < calc_dim){
        //         //     p25 = page_ptr[lane_id + 768];
        //         // }
        //         // float p26 = 0;
        //         // if(lane_id + 800 < calc_dim){
        //         //     p26 = page_ptr[lane_id + 800];
        //         // }
        //         // float p27 = 0;
        //         // if(lane_id + 832 < calc_dim){
        //         //     p27 = page_ptr[lane_id + 832];
        //         // }
        //         // float p28 = 0;
        //         // if(lane_id + 864 < calc_dim){
        //         //     p28 = page_ptr[lane_id + 864];
        //         // }
        //         // float p29 = 0;
        //         // if(lane_id + 896 < calc_dim){
        //         //     p29 = page_ptr[lane_id + 896];
        //         // }
        //         // float p30 = 0;
        //         // if(lane_id + 928 < calc_dim){
        //         //     p30 = page_ptr[lane_id + 928];
        //         // }
        //     // #endregion PARTIAL_DIM d_data loading without DEFINE

        //     // #region PARTIAL_DIM distance reduction without DEFINE
        //         float delta1 = 0;
        //         if(lane_id < calc_dim){
        //             delta1 = (p1 - q1_tail) * (p1 - q1_tail);
        //         }
        //         float delta2 = 0;
        //         if(lane_id + 32 < calc_dim){
        //             delta2 = (p2 - q2_tail) * (p2 - q2_tail);
        //         }
        //         float delta3 = 0;
        //         if(lane_id + 64 < calc_dim){
        //             delta3 = (p3 - q3_tail) * (p3 - q3_tail);
        //         }
        //         // float delta4 = 0;
        //         // if(lane_id + 96 < calc_dim){
        //         //     delta4 = (p4 - q4_tail) * (p4 - q4_tail);
        //         // }
        //         // float delta5 = 0;
        //         // if(lane_id + 128 < calc_dim){
        //         //     delta5 = (p5 - q5_tail) * (p5 - q5_tail);
        //         // }
        //         // float delta6 = 0;
        //         // if(lane_id + 160 < calc_dim){
        //         //     delta6 = (p6 - q6_tail) * (p6 - q6_tail);
        //         // }
        //         // float delta7 = 0;
        //         // if(lane_id + 192 < calc_dim){
        //         //     delta7 = (p7 - q7_tail) * (p7 - q7_tail);
        //         // }
        //         // float delta8 = 0;
        //         // if(lane_id + 224 < calc_dim){
        //         //     delta8 = (p8 - q8_tail) * (p8 - q8_tail);
        //         // }
        //         // float delta9 = 0;
        //         // if(lane_id + 256 < calc_dim){
        //         //     delta9 = (p9 - q9_tail) * (p9 - q9_tail);
        //         // }
        //         // float delta10 = 0;
        //         // if(lane_id + 288 < calc_dim){
        //         //     delta10 = (p10 - q10_tail) * (p10 - q10_tail);
        //         // }
        //         // float delta11 = 0;
        //         // if(lane_id + 320 < calc_dim){
        //         //     delta11 = (p11 - q11_tail) * (p11 - q11_tail);
        //         // }
        //         // float delta12 = 0;
        //         // if(lane_id + 352 < calc_dim){
        //         //     delta12 = (p12 - q12_tail) * (p12 - q12_tail);
        //         // }
        //         // float delta13 = 0;
        //         // if(lane_id + 384 < calc_dim){
        //         //     delta13 = (p13 - q13_tail) * (p13 - q13_tail);
        //         // }
        //         // float delta14 = 0;
        //         // if(lane_id + 416 < calc_dim){
        //         //     delta14 = (p14 - q14_tail) * (p14 - q14_tail);
        //         // }
        //         // float delta15 = 0;
        //         // if(lane_id + 448 < calc_dim){
        //         //     delta15 = (p15 - q15_tail) * (p15 - q15_tail);
        //         // }
        //         // float delta16 = 0;
        //         // if(lane_id + 480 < calc_dim){
        //         //     delta16 = (p16 - q16_tail) * (p16 - q16_tail);
        //         // }
        //         // float delta17 = 0;
        //         // if(lane_id + 512 < calc_dim){
        //         //     delta17 = (p17 - q17_tail) * (p17 - q17_tail);
        //         // }
        //         // float delta18 = 0;
        //         // if(lane_id + 544 < calc_dim){
        //         //     delta18 = (p18 - q18_tail) * (p18 - q18_tail);
        //         // }
        //         // float delta19 = 0;
        //         // if(lane_id + 576 < calc_dim){
        //         //     delta19 = (p19 - q19_tail) * (p19 - q19_tail);
        //         // }
        //         // float delta20 = 0;
        //         // if(lane_id + 608 < calc_dim){
        //         //     delta20 = (p20 - q20_tail) * (p20 - q20_tail);
        //         // }
        //         // float delta21 = 0;
        //         // if(lane_id + 640 < calc_dim){
        //         //     delta21 = (p21 - q21_tail) * (p21 - q21_tail);
        //         // }
        //         // float delta22 = 0;
        //         // if(lane_id + 672 < calc_dim){
        //         //     delta22 = (p22 - q22_tail) * (p22 - q22_tail);
        //         // }
        //         // float delta23 = 0;
        //         // if(lane_id + 704 < calc_dim){
        //         //     delta23 = (p23 - q23_tail) * (p23 - q23_tail);
        //         // }
        //         // float delta24 = 0;
        //         // if(lane_id + 736 < calc_dim){
        //         //     delta24 = (p24 - q24_tail) * (p24 - q24_tail);
        //         // }
        //         // float delta25 = 0;
        //         // if(lane_id + 768 < calc_dim){
        //         //     delta25 = (p25 - q25_tail) * (p25 - q25_tail);
        //         // }
        //         // float delta26 = 0;
        //         // if(lane_id + 800 < calc_dim){
        //         //     delta26 = (p26 - q26_tail) * (p26 - q26_tail);
        //         // }
        //         // float delta27 = 0;
        //         // if(lane_id + 832 < calc_dim){
        //         //     delta27 = (p27 - q27_tail) * (p27 - q27_tail);
        //         // }
        //         // float delta28 = 0;
        //         // if(lane_id + 864 < calc_dim){
        //         //     delta28 = (p28 - q28_tail) * (p28 - q28_tail);
        //         // }
        //         // float delta29 = 0;
        //         // if(lane_id + 896 < calc_dim){
        //         //     delta29 = (p29 - q29_tail) * (p29 - q29_tail);
        //         // }
        //         // float delta30 = 0;
        //         // if(lane_id + 928 < calc_dim){
        //         //     delta30 = (p30 - q30_tail) * (p30 - q30_tail);
        //         // }
        //     // #endregion PARTIAL_DIM distance reduction without DEFINE

        //     // #region PARTIAL_DIM distance reduction with DEFINE
        //         partial_dist += delta1;
        //         partial_dist += delta2;
        //         partial_dist += delta3;
        //         // partial_dist += delta4;
        ...
        //         partial_dist += __shfl_down_sync(FULL_MASK, partial_dist, 2);
        //         partial_dist += __shfl_down_sync(FULL_MASK, partial_dist, 1);
        //     // #endregion PARTIAL_DIM distance reduction with DEFINE
            
        //     if(lane_id == 0){
        //         dist += partial_dist;
        //         if(used_dim < FULL_DIM && linear_dim > 0 && linear_w && linear_b){
        //             float w = in_cache ? linear_w_high : linear_w_low;
        //             float b = in_cache ? linear_b_high : linear_b_low;
        //             // float w = linear_w_low;
        //             // float b = linear_b_low;
        //             dist = w * dist + b;
        //             // int idx = (linear_dim < used_dim ? linear_dim : used_dim);
